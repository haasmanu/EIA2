...
(function (Aufgabe6Shop) {
    ...
    function createFieldset() {
        ...
        for (let i = 0; i < Aufgabe6Shop.tree.length; i++) {
            childNodeHTML += "<option value='" + i + Aufgabe6Shop.tree[i].name + " " + Aufgabe6Shop.tree[i].price + " Euro'>" + Aufgabe6Shop.tree[i].name + " " + Aufgabe6Shop.tree[i].price + " Euro</option>";
        }
        ...
        for (let i = 0; i < Aufgabe6Shop.treeBall.length; i++) {
            childNodeHTML += "<option value='" + i + Aufgabe6Shop.treeBall[i].name + " " + Aufgabe6Shop.treeBall[i].price + " Euro'>" + Aufgabe6Shop.treeBall[i].name + " " + Aufgabe6Shop.treeBall[i].price + " Euro</option>";
        }
        childNodeHTML += "</select>";
        ...
        for (let i = 0; i < Aufgabe6Shop.candle.length; i++) {
            childNodeHTML += "<option value='" + i + Aufgabe6Shop.candle[i].name + " " + Aufgabe6Shop.candle[i].price + " Euro'>" + Aufgabe6Shop.candle[i].name + " " + Aufgabe6Shop.candle[i].price + " Euro</option>";
        }
        childNodeHTML += "</select>";
        childNodeHTML += "<h3>How many?</h3>";
        ...
        for (let i = 0; i < Aufgabe6Shop.lametta.length; i++) {
            childNodeHTML += "<option value='" + i + Aufgabe6Shop.lametta[i].name + " " + Aufgabe6Shop.lametta[i].price + " Euro'>" + Aufgabe6Shop.lametta[i].name + " " + Aufgabe6Shop.lametta[i].price + " Euro</option>";
        }
        childNodeHTML += "</select>";
        childNodeHTML += "<h3>How many?</h3>";
        ...
        for (let i = 0; i < Aufgabe6Shop.additional.length; i++) {
            childNodeHTML += "<input type= 'radio' name= 'Radiogroup2' value='" + i + Aufgabe6Shop.additional[i].name + " " + Aufgabe6Shop.additional[i].price + " Euro' id='treeTop" + i + "' />";
            childNodeHTML += "<label for= 'check" + i + "'>" + Aufgabe6Shop.additional[i].name + " " + Aufgabe6Shop.additional[i].price + "Euro</label>";
        }
        childNodeHTML += "</fieldset>";
        childNodeHTML += "<hr>";
        //Tree Stand
        ...
        for (let i = 0; i < Aufgabe6Shop.treeStand.length; i++) {
            childNodeHTML += "<input type='radio' name='Radiogroup3' value='" + i + Aufgabe6Shop.treeStand[i].name + " " + Aufgabe6Shop.treeStand[i].price + " Euro'  id='treeStand" + i + "' />";
            childNodeHTML += "<label for='check" + i + "'>" + Aufgabe6Shop.treeStand[i].name + " " + Aufgabe6Shop.treeStand[i].price + " Euro</label>";
        }
        childNodeHTML += "</fieldset>";
        childNodeHTML += "<hr>";
        //Shipping
        ...
        for (let i = 0; i < Aufgabe6Shop.shipment.length; i++) {
            childNodeHTML += "<input type='radio' name='Radiogroup4' value='" + i + Aufgabe6Shop.shipment[i].name + " " + Aufgabe6Shop.shipment[i].price + " Euro'  id='shipping" + i + "' />";
            childNodeHTML += "<label for='check" + i + "'>" + Aufgabe6Shop.shipment[i].name + " " + Aufgabe6Shop.shipment[i].price + " Euro</label>";
        }
        childNodeHTML += "</fieldset>";
        childNodeHTML += "<hr>";
        //Adresse
    ...
    function handleChange(_event) {
        ...
        if (target.id == "trees") {
            ...
            priceTree = Aufgabe6Shop.tree[priceIndex].price;
            let childNodeHTML;
            childNodeHTML = "";
            childNodeHTML += "<a>";
        ...
        if (target.id == "balls") {
            ...
            let value = target.value;
            let priceIndex = parseInt(value.substr(0, 1));
            priceBalls = Aufgabe6Shop.treeBall[priceIndex].price;
            let childNodeHTML;
            childNodeHTML = "";
            childNodeHTML += "<a>";
            childNodeHTML += " " + value.substr(1);
        ...
        if (target.id == "balls2") {
            ...
            let value = target.value;
            let priceIndex = parseInt(value.substr(0, 1));
            priceBalls2 = Aufgabe6Shop.treeBall[priceIndex].price;
            let childNodeHTML;
            childNodeHTML = "";
            childNodeHTML += "<a>";
            childNodeHTML += " " + value.substr(1);
        ...
        if (target.id == "candles") {
            ...
            let value = target.value;
            let priceIndex = parseInt(value.substr(0, 1));
            priceCandle = Aufgabe6Shop.candle[priceIndex].price;
        ...
        if (target.id == "candles2") {
            ...
            let value = target.value;
            let priceIndex = parseInt(value.substr(0, 1));
            priceCandle2 = Aufgabe6Shop.candle[priceIndex].price;
        ...
        if (target.name == "lamettas") {
            ...
            let value = target.value;
            let priceIndex = parseInt(value.substr(0, 1));
            priceLametta = Aufgabe6Shop.lametta[priceIndex].price;
        ...
        if (target.name == "lamettas2") {
            ...
            let value = target.value;
            let priceIndex = parseInt(value.substr(0, 1));
            priceLametta2 = Aufgabe6Shop.lametta[priceIndex].price;
            let childNodeHTML;
            childNodeHTML = "";
            childNodeHTML += "<a>";
            childNodeHTML += " " + value.substr(1);
        ...
        if (target.name == "Radiogroup3") {
            ...
            let value = target.value;
            let priceIndex = parseInt(value.substr(0, 1));
            priceTreeStand = Aufgabe6Shop.treeStand[priceIndex].price;
            let childNodeHTML;
            childNodeHTML = "";
            childNodeHTML += "<a>";
            childNodeHTML += " " + value.substr(1);
        ...
        if (target.name == "Radiogroup2") {
            ...
            let value = target.value;
            let priceIndex = parseInt(value.substr(0, 1));
            priceAdditional = Aufgabe6Shop.additional[priceIndex].price;
            let childNodeHTML;
            childNodeHTML = "";
            childNodeHTML += "<a>";
            childNodeHTML += " " + value.substr(1);
        ...
        if (target.name == "Radiogroup4") {
            ...
            let value = target.value;
            let priceIndex = parseInt(value.substr(0, 1));
            priceShipping = Aufgabe6Shop.shipment[priceIndex].price;
            let childNodeHTML;
            childNodeHTML = "";
            childNodeHTML += "<a>";
            childNodeHTML += " " + value.substr(1);
