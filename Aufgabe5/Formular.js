...
(function (Aufgabe5Shop) {
    ...
    function createFieldset() {
        ...
        for (let i = 0; i < Aufgabe5Shop.tree.length; i++) {
            childNodeHTML += "<option value='" + i + Aufgabe5Shop.tree[i].name + " " + Aufgabe5Shop.tree[i].price + " Euro'>" + Aufgabe5Shop.tree[i].name + " " + Aufgabe5Shop.tree[i].price + " Euro</option>";
        }
        ...
        for (let i = 0; i < Aufgabe5Shop.treeBall.length; i++) {
            childNodeHTML += "<option value='" + i + Aufgabe5Shop.treeBall[i].name + " " + Aufgabe5Shop.treeBall[i].price + " Euro'>" + Aufgabe5Shop.treeBall[i].name + " " + Aufgabe5Shop.treeBall[i].price + " Euro</option>";
        }
        childNodeHTML += "</select>";
        ...
        for (let i = 0; i < Aufgabe5Shop.candle.length; i++) {
            childNodeHTML += "<option value='" + i + Aufgabe5Shop.candle[i].name + " " + Aufgabe5Shop.candle[i].price + " Euro'>" + Aufgabe5Shop.candle[i].name + " " + Aufgabe5Shop.candle[i].price + " Euro</option>";
        }
        childNodeHTML += "</select>";
        childNodeHTML += "<h3>How many?</h3>";
        ...
        for (let i = 0; i < Aufgabe5Shop.lametta.length; i++) {
            childNodeHTML += "<option value='" + i + Aufgabe5Shop.lametta[i].name + " " + Aufgabe5Shop.lametta[i].price + " Euro'>" + Aufgabe5Shop.lametta[i].name + " " + Aufgabe5Shop.lametta[i].price + " Euro</option>";
        }
        childNodeHTML += "</select>";
        childNodeHTML += "<h3>How many?</h3>";
        ...
        for (let i = 0; i < Aufgabe5Shop.additional.length; i++) {
            childNodeHTML += "<input type= 'radio' name= 'Radiogroup2' value='" + i + Aufgabe5Shop.additional[i].name + " " + Aufgabe5Shop.additional[i].price + " Euro' id='treeTop" + i + "' />";
            childNodeHTML += "<label for= 'check" + i + "'>" + Aufgabe5Shop.additional[i].name + " " + Aufgabe5Shop.additional[i].price + "Euro</label>";
        }
        childNodeHTML += "</fieldset>";
        childNodeHTML += "<hr>";
        //Tree Stand
        ...
        for (let i = 0; i < Aufgabe5Shop.treeStand.length; i++) {
            childNodeHTML += "<input type='radio' name='Radiogroup3' value='" + i + Aufgabe5Shop.treeStand[i].name + " " + Aufgabe5Shop.treeStand[i].price + " Euro'  id='treeStand" + i + "' />";
            childNodeHTML += "<label for='check" + i + "'>" + Aufgabe5Shop.treeStand[i].name + " " + Aufgabe5Shop.treeStand[i].price + " Euro</label>";
        }
        childNodeHTML += "</fieldset>";
        childNodeHTML += "<hr>";
        //Shipping
        ...
        for (let i = 0; i < Aufgabe5Shop.shipment.length; i++) {
            childNodeHTML += "<input type='radio' name='Radiogroup4' value='" + i + Aufgabe5Shop.shipment[i].name + " " + Aufgabe5Shop.shipment[i].price + " Euro'  id='shipping" + i + "' />";
            childNodeHTML += "<label for='check" + i + "'>" + Aufgabe5Shop.shipment[i].name + " " + Aufgabe5Shop.shipment[i].price + " Euro</label>";
        }
        childNodeHTML += "</fieldset>";
        childNodeHTML += "<hr>";
        //Adresse
    ...
    function handleChange(_event) {
        ...
        if (target.id == "trees") {
            ...
            priceTree = Aufgabe5Shop.tree[priceIndex].price;
            let childNodeHTML;
            childNodeHTML = "";
            childNodeHTML += "<a>";
        ...
        if (target.id == "balls") {
            ...
            let value = target.value;
            let priceIndex = parseInt(value.substr(0, 1));
            priceBalls = Aufgabe5Shop.treeBall[priceIndex].price;
            let childNodeHTML;
            childNodeHTML = "";
            childNodeHTML += "<a>";
            childNodeHTML += " " + value.substr(1);
        ...
        if (target.id == "balls2") {
            ...
            let value = target.value;
            let priceIndex = parseInt(value.substr(0, 1));
            priceBalls2 = Aufgabe5Shop.treeBall[priceIndex].price;
            let childNodeHTML;
            childNodeHTML = "";
            childNodeHTML += "<a>";
            childNodeHTML += " " + value.substr(1);
        ...
        if (target.id == "candles") {
            ...
            let value = target.value;
            let priceIndex = parseInt(value.substr(0, 1));
            priceCandle = Aufgabe5Shop.candle[priceIndex].price;
        ...
        if (target.id == "candles2") {
            ...
            let value = target.value;
            let priceIndex = parseInt(value.substr(0, 1));
            priceCandle2 = Aufgabe5Shop.candle[priceIndex].price;
        ...
        if (target.name == "lamettas") {
            ...
            let value = target.value;
            let priceIndex = parseInt(value.substr(0, 1));
            priceLametta = Aufgabe5Shop.lametta[priceIndex].price;
        ...
        if (target.name == "lamettas2") {
            ...
            let value = target.value;
            let priceIndex = parseInt(value.substr(0, 1));
            priceLametta2 = Aufgabe5Shop.lametta[priceIndex].price;
            let childNodeHTML;
            childNodeHTML = "";
            childNodeHTML += "<a>";
            childNodeHTML += " " + value.substr(1);
        ...
        if (target.name == "Radiogroup3") {
            ...
            let value = target.value;
            let priceIndex = parseInt(value.substr(0, 1));
            priceTreeStand = Aufgabe5Shop.treeStand[priceIndex].price;
            let childNodeHTML;
            childNodeHTML = "";
            childNodeHTML += "<a>";
            childNodeHTML += " " + value.substr(1);
        ...
        if (target.name == "Radiogroup2") {
            ...
            let value = target.value;
            let priceIndex = parseInt(value.substr(0, 1));
            priceAdditional = Aufgabe5Shop.additional[priceIndex].price;
            let childNodeHTML;
            childNodeHTML = "";
            childNodeHTML += "<a>";
            childNodeHTML += " " + value.substr(1);
        ...
        if (target.name == "Radiogroup4") {
            ...
            let value = target.value;
            let priceIndex = parseInt(value.substr(0, 1));
            priceShipping = Aufgabe5Shop.shipment[priceIndex].price;
            let childNodeHTML;
            childNodeHTML = "";
            childNodeHTML += "<a>";
            childNodeHTML += " " + value.substr(1);
